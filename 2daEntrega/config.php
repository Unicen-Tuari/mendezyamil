...
$acciones = [
  ...
  "registrar" => "UsuariosController#crearUsuario",
  "guardarusuario" => "UsuariosController#guardarUsuario",
  "borrarusuario" => "UsuariosController#borrarUsuario",
  "modificarusuario" => "UsuariosController#modificarUsuario",
  "updateusuario" => "UsuariosController#updateUsuario",
  "verautos" => "AutosController#mostrarAutos",
  "vermarcas" => "AutosController#mostrarMarcas",
  "verusuarios" => "UsuariosController#mostrarUsuarios",
